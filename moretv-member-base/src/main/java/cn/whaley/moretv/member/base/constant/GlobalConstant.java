...
public interface GlobalConstant {
    ...
    //片库-节目包队列
    String MORETV_PUBLISH_CONTENT_PRODUCT_PACKAGE_QUEUE = "moretv.publish.content.product.package.queue";
    ...
    // 电视猫订单队列
    String MORETV_PUBLISH_BUSINESS_EXCHANGE = "moretv.publish.order";
    ...
    //电视猫发货订单
    String MORETV_PUBLISH_DELIVERED_ORDER_ROUTER_KEY = "moretv.publish.delivered.order.router.key";
